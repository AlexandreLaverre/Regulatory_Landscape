...
pathExpression="../../../RegulatoryLandscapesManuscript/SupplementaryDataset6b/"
...
for(sp in c("human", "mouse")){
  ...
  results=data.frame("GeneID"=rownames(avgexp), "TauRPKM"=tau.rpkm, "TauLogRPKM"=tau.logrpkm, "MaxRPKM"=maxexp, "MaxSample"=maxsample, "MaxTissue"=maxtiss, "MaxAge"=maxage, "NbSamplesDetectedExpression"=nbsamplesexp, stringsAsFactors=F)
