...
interest_files=(annotations/all_exons.bed annotations/all_genes.bed)
...
suffix=${suffix##*/}
	...
	${pathScripts}/overlap.py ${specie} ${enh} ${file} overlap/${prefix}_overlap_${suffix}_500kb.txt --extend 500000 --intraoverlap --count_window -v
	fi
	done
done
