...
pdf(paste(pathFigures, "SupplementaryFigure16.pdf", sep=""), width=6.85, height=4)
...
tiplabels(species_names, bg = NA, adj = -0.1, frame="none", cex=1.1)

 # legend for the plot

legend("bottomleft", fill=dataset.colors, border=dataset.colors, legend = c("PCHi-C data", "simulated data"), bty='n', cex=1.3, xpd=T, inset=c(-0.01, -0.15), horiz=FALSE)
