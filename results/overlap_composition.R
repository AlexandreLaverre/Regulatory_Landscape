...
plot(conserv_dist$inter[1:50], type="b", col="red", ylim=c(1.5,8), main="Coding exon", xlab="",ylab="Mean fragment proportion (%)", xaxt = "n")
...
plot(conserv_dist$inter[1:50], type="b", col="red", ylim=c(0, 3),main="Non coding exon", xlab="",ylab="", xaxt = "n")
for (row in 1:nrow(conserv_dist[1:50,])){
  segments(x0=row,y0=conserv_dist[row,]$int_start,x1=row,y1=conserv_dist[row,]$int_end, col='red', lwd=0.3)}
...
plot(conserv_dist$inter[1:50], type="b", col="red", ylim=c(3.5, 7),main="Phastcons Element", xlab="",ylab="Mean fragment proportion (%)", xaxt = "n")
for (row in 1:nrow(conserv_dist[1:50,])){
  segments(x0=row,y0=conserv_dist[row,]$int_start,x1=row,y1=conserv_dist[row,]$int_end, col='red', lwd=0.3)}
...
plot(conserv_dist$inter[1:50], type="b", col="red", ylim=c(28, 50),main="Repeat Element", xlab="",ylab="", xaxt = "n")
for (row in 1:nrow(conserv_dist[1:50,])){
  segments(x0=row,y0=conserv_dist[row,]$int_start,x1=row,y1=conserv_dist[row,]$int_end, col='red', lwd=0.3)}
