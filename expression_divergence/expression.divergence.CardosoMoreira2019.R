...
for(set in c("AllOrgans", "SomaticOrgans")){
  ...
  write.table(results, file=paste(pathExpressionData, "expression_divergence/ExpressionDivergence_CardosoMoreira2019_", set,".txt",sep=""), row.names=F, col.names=T, sep="\t", quote=F)
