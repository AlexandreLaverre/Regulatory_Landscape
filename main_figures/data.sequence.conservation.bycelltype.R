...
for(ref_sp in c("human", "mouse")){
  ...
  for(type in c("IdenticalSequence", "UngappedAlignment")){
    ...
    for (enh in enhancers){
      ...
      enh_obs_stats=enh_obs_stats[which(enh_obs_stats$enh%in%enh.contact.obs$enhancer),]
      enh_simul_stats=enh_simul_stats[which(enh_simul_stats$enh%in%enh.contact.obs$enhancer),]
