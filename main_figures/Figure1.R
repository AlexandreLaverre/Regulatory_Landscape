...
mtext("C", side=3, line=0.5, at=shhxlim[1]-diff(shhxlim)/7.5, font=2, cex=1.1)
...
mtext("A", side=3, line=1, at=-3.9, font=2, cex=1.1)
...
mtext("B", side=3, line=1, at=-3.15e5, font=2, cex=1.1)
