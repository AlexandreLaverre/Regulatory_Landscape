...
#points(human_enh_dist_simul$CAGE[0:50], type="l", col="blue", lwd=1.2)
#for (row in 1:nrow(human_enh_dist_simul[0:50,])){
#  segments(x0=row,y0=human_enh_dist_simul[row,]$CAGE_conflow,x1=row,y1=human_enh_dist_simul[row,]$CAGE_confup, col="blue", lwd=0.4)}
...
legend("topright", legend=c("RoadMap", "ENCODE", "GRO_seq","CAGE"), fill=c("forestgreen", "dodgerblue3", "orange","red"), bty='n', cex=CEX-0.1)
