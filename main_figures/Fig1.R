...
contact_human <- read.table("/home/laverre/Documents/Regulatory_Landscape/data/human/all_interactions/all_interactions_chr_merged.txt_test_cell", header=T)
contact_mouse <- read.table("/home/laverre/Documents/Regulatory_Landscape/data/mouse/all_interactions/all_interactions_chr_merged.txt_test_cell", header=T)
...
contact_human <- contact_human[which(contact_human$dist < 10000000),]
contact_mouse <- contact_mouse[which(contact_mouse$dist < 10000000),]
...
legend("topright", legend=c("Mouse bait-bait", "Mouse bait-other", "Human bait-bait", "Human bait-other"),
       fill=c("red", "orange", "blue", "deepskyblue"), bty='n', cex=CEX)
