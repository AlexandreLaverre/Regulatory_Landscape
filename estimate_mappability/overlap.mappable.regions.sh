...
perl ${pathScripts}/overlap.mappable.regions.pl --pathRestrictionFragments=${pathFragments}/frag_coords_${genome}.bed --pathMappedRegions=${pathResults}/mapped_regions.txt --margin=1000 --step=10 --pathOutput=${pathResults}/overlap_restriction_fragments_mapped_regions_margin1000_step10.txt
