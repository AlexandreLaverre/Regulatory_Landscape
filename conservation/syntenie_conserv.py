...
def sorted_dictionary(origin_sp, target_sp, data):
    ...
    frag_conserv = {}
    with open("../../result/alignments/AlignmentStatistics_PECAN_ExcludingExons_"+origin_sp+"2"+target_sp+".txt") as f1:
    ...
    output = open("../../result/conservation/"+origin_sp+"2"+target_sp+"_conservation_syntenie_with_notconserv"+data+".txt2", 'w')
    if os.stat("../../result/conservation/"+origin_sp+"2"+target_sp+"_conservation_syntenie_with_notconserv"+data+".txt2").st_size == 0:
