...
if [ -e ${pathResults}/${score}_${way}_${suffixExons}_RepeatMasker.txt ]; then
...
do
    if [ -e ${pathResults}/${score}_${way}_${suffixExons}_RepeatMasker.txt ]; then
	sed '1d' ${pathResults}/${score}_${way}_chr${chr}_${suffixExons}_RepeatMasker.txt >> ${pathResults}/${score}_${way}_${suffixExons}_RepeatMasker.txt
    else
	cat ${pathResults}/${score}_${way}_chr${chr}_${suffixExons}_RepeatMasker.txt > ${pathResults}/${score}_${way}_${suffixExons}_RepeatMasker.txt
    fi
done
