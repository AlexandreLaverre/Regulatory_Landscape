...
$parameters{"minValue"}="NA";
$parameters{"pathOutput"}="NA";

my @defaultpars=("pathContacts", "pathPromoterExpression", "pathEnhancerExpression", "minValue", "pathOutput");
...
print "Evaluating shared activity and writing output...\n";
...
print $output $line."\tNbExpPromoter\tNbExpEnhancer\tNbExpBoth\n";

my $minval=$parameters{"minValue"}+0.0;

print "threshold ".$minval." for the expression level.\n";
...
while($line){
    ...
    print $output $line."\t".$nbexpprom."\t".$nbexpenh."\t".$nbexpboth."\n";
