...
load(paste(pathFOCS, sp, "/RoadmapEpigenomics/roadmap.enh.rpkm.RData", sep=""))
load(paste(pathFOCS, sp, "/RoadmapEpigenomics/roadmap.prom.rpkm.RData", sep=""))
version="hg19"
...
write.table(results, file=paste(pathFOCS, sp, "/RoadmapEpigenomics/enhancer_coordinates_",version,".bed", sep=""), row.names=F, col.names=F, sep="\t", quote=F)
...
write.table(results, file=paste(pathFOCS, sp, "/RoadmapEpigenomics/promoter_coordinates_",version,".bed", sep=""), row.names=F, col.names=F, sep="\t", quote=F)
...
write.table(Me_fpkm, file=paste(pathFOCS, sp, "/RoadmapEpigenomics/enhancer_activity.txt", sep=""), row.names=T, col.names=T, sep="\t", quote=F)

write.table(Mg_fpkm, file=paste(pathFOCS, sp, "/RoadmapEpigenomics/promoter_activity.txt", sep=""), row.names=T, col.names=T, sep="\t", quote=F)
