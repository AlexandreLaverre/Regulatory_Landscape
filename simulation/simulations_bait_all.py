...
output = open(path_result+sp+"_samples/simulations_10Mb_bin5kb_fragoverbin_"+cell_type+".txt", 'w')
if os.stat(path_result+sp+"_samples/simulations_10Mb_bin5kb_fragoverbin_"+cell_type+".txt").st_size == 0:
