...
sub printHelp{
    ...
    print "\n";
    print "This script combines bed coordinates.\n";
    print "\n";
...
my @defaultpars=("pathsCoordinates","pathOutput");
my %defaultvalues;
...
my %coordinates;
my @paths=split(",", $parameters{"pathsCoordinates"});

foreach my $path (@paths){
    if(-e $path){
	print "reading from ".$path."\n";
	readCoordinates($path, \%coordinates);
    }
}
...
my %combined;
combineCoordinates(\%coordinates, \%combined);
print "Done.\n";
