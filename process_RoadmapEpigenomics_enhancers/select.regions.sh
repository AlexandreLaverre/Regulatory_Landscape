...
perl ${pathScripts}/select.regions.pl --pathCombinedCoverage=${pathResults}/${prefix}_coverage_allsamples.txt --minCoverage=5 --minSamples=5 --pathOutput=${pathResults}/selected_${type}_coverage_allsamples.txt
