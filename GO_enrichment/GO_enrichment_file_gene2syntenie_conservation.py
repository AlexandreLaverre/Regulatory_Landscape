...
if data == "_simul":
    infile = path + "result/conservation/syntenie_conservation/human/human2mouse_conservation_syntenie_with_notconserv_simul.txt"
else:
    infile = path + "result/conservation/syntenie_conservation/human/human2mouse_conservation_syntenie_with_notconserv.txt"
...
output = open("../../result/conservation/GOrilla/"+sp+"/gene_syntenie_conserv_sup85%.txt", 'w')
background = open("../../result/conservation/GOrilla/"+sp+"/"+sp+"_background_genes_syntenie.txt", 'w')
distrib = open("../../result/conservation/GOrilla/"+sp+"/gene_syntenie_distribution.txt", 'w')
...
for gene in gene2bait.keys():
    ...
    if count_contact != 0:
        ...
        if count_conserv/count_contact > 0.85:
            output.write(gene + '\n')
