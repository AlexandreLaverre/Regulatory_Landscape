...
path_data = "/beegfs/data/alaverre/data/"
path_result = "/beegfs/data/alaverre/result/simulations/"
...
with open(path_data+"all_interactions_"+sp+".txt") as f3:
...
output = open(path_result+"/simulations_"+sp+"_10Mb_bin5kb_fragoverbin.txt", 'w')
if os.stat(path_result+"/simulations_"+sp+"_10Mb_bin5kb_fragoverbin.txt").st_size == 0:
